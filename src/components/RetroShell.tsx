...
export function RetroShell({ children }: ShellProps) {
    return (
        <div className="min-h-screen h-screen overflow-hidden bg-neutral-800 flex flex-col items-center justify-center p-2 sm:p-4">
            <div className="relative w-full max-w-[600px] h-full max-h-[90vh] flex flex-col bg-retro-orange rounded-[30px] sm:rounded-[40px] p-2 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_-8px_10px_rgba(0,0,0,0.3)] border-b-8 border-[#A04000]">
                ...
                {/* Main Content Area */}
                <div className="relative z-10 flex flex-col gap-2 sm:gap-6 flex-1 h-full">
                    {/* Brand Logo Area */}
