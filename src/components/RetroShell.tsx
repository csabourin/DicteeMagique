...
export function RetroShell({ children }: ShellProps) {
    return (
        <div className="min-h-screen bg-neutral-800 flex items-center justify-center p-4">
            <div className="relative w-full max-w-[600px] bg-retro-orange rounded-[40px] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_-8px_10px_rgba(0,0,0,0.3)] border-b-8 border-[#A04000]">

                {/* Handle (La poignée typique) */}
                <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-48 h-20 border-[24px] border-retro-orange rounded-t-[40px] border-b-0 shadow-[inset_0_10px_10px_rgba(0,0,0,0.2)] z-0 flex items-end justify-center">
                    {/* Inner part of handle background */}
                    <div className="w-full h-full bg-neutral-800 rounded-t-[20px] translate-y-2 opacity-50 blur-sm"></div>
                </div>
